...
public:
    ...
    inline void set_order(const int& j)
    {
        set_basis_order(j);
        set_der_order();
    }
    ...
    {
        cout << endl
             << "Coefficients of the basis in decreasing order" << endl
             << endl;
        mat_disp<double>(basis_coeff);
        cout << endl;
    }
    inline void disp_der(void)
    {
        cout << endl
             << "Coefficients of the first derivative of the basis in decreasing order" << endl
             << endl;
        mat_disp<double>(der_basis_coeff);
        cout << endl;
    }
