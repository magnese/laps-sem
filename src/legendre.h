...
public:
  ...
  legendre(const int& order=1):leg_coeff(2),leg_der_coeff(2),leg_coeff_reverse(0),leg_der_coeff_reverse(0){
  ...
  inline void disp(void){cout<<endl<<"Legendre coefficients in decreasing order"<<endl<<endl;
    mat_disp<double>(leg_coeff);cout<<endl;}
  inline void disp_der(void){cout<<endl<<"Legendre derivative coefficients in decreasing order"<<endl<<endl;
    mat_disp<double>(leg_der_coeff);cout<<endl;}
  inline void disp_reverse(void){cout<<endl<<"Legendre coefficients in increasing order"<<endl<<endl;
    mat_disp<double>(leg_coeff_reverse);cout<<endl;}
  inline void disp_der_reverse(void){cout<<endl<<"Legendre derivative coefficients in increasing order"<<endl<<endl;
    mat_disp<double>(leg_der_coeff_reverse);cout<<endl;}
